...
console.log(Math.round(123.56)); //반올림 123.56 -> 124
console.log(Math.ceil(123.01)); //올림 123.01 -> 124
console.log(Math.floor(123.999)); //내림 123.999 -> 123
console.log(Math.floor(-123.999)); //내림 -123.999 -> -124

console.log(Math.trunc(123.55)); //소수점 제거 123.55 -> 123
console.log(Math.trunc(-123.55)); // -123.999 -> -123
